...
class Device
    ...
    : public Utility::StackPImpl<Device, 23 * sizeof( void * ) + 9 * sizeof( int ) + 2 * 36, 16>
#elif defined( __ANDROID__ )
    : public Utility::StackPImpl<Device, 20 * sizeof( void * ) + 9 * sizeof( int )         ,  8>
...
private:
    ...
    error_msg_t setCallbackMoveable( Functor && functor, std::false_type )
    {
        auto pFunctor( std::make_shared<Functor>( std::move( functor ) ) );
