...
namespace Detail
{
    ...
    template <class TraitTag, class... TraitsSequence> struct GetTraitImpl;

    template <class TraitTag>
    struct GetTraitImpl<TraitTag> { typedef boost::mpl::void_ type; };

    template <class TraitTag, class FirstTrait, class... TraitsSequence>
    struct GetTraitImpl<TraitTag, FirstTrait, TraitsSequence...> : GetTraitImpl<TraitTag, TraitsSequence...> {};

    template <class TraitTag, class Value, class... TraitsSequence>
    struct GetTraitImpl<TraitTag, boost::mpl::pair<TraitTag, Value>, TraitsSequence...> { typedef Value type; };

    template <class TraitTag, class... TraitsSequence>
    using GetTrait = GetTraitImpl<TraitTag, typename TraitsSequence::type...>;

    template <class TraitTag, class TraitsPack, typename... DefaultTraits>
    struct GetTraitDefaulted;

    template <class TraitTag, typename... TraitsParam, typename... DefaultsParam>
    struct GetTraitDefaulted<TraitTag, TraitPack<TraitsParam...>, DefaultsParam...>
        : GetTrait<TraitTag, TraitsParam..., DefaultsParam...> {};

    template <class TraitTag, typename... TraitsParam, class... DefaultsParam>
